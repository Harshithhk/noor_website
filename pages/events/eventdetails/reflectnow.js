        ...
        <main>
          ...
          <section className={styles.description}>
            <div className={styles.desc_container}>
              <div className={styles.desc_date}>8 Jan 2021</div>
              <div className={styles.desc_heading}>Reflect: Now</div>
              <div className={styles.desc_description}>
                It’s human to make mistakes but … <br />
                <br /> The years in one’s life are often so impacting, they make you who you are and prepare you for who you want to be ahead. It is
                only human to make mistakes, but it is celestial to learn from it and create a better future for self. Regrets, mistakes on one hand,
                and achievements, treasured memories on the other. A perfection session for addressing who we were, who we are and who we aspire to
                be.
              </div>
            </div>
          </section>
