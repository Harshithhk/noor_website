        ...
        <main>
          ...
          <section className={styles.description}>
            <div className={styles.desc_container}>
              <div className={styles.desc_date}>26 March 2020</div>
              <div className={styles.desc_heading}>Unfold : March 2020</div>
              <div className={styles.desc_description}>
                Closed eyes and open minds, could only make the talks deeper and more meaningful. <br /> <br /> “Closed eyes and open minds, could
                only make the talks deeper and more meaningful.” That’s just how Unfold - February, 2020 was.❤️❤️ . . <br /> <br /> Not only a session
                but a wholesome experience of being brave enough to pour your hearts out to strangers in exchange for support and encouragement. The
                participants unveiled answers to others’ deep questions and we were enlightened about lesser known and intriguing topics like
                'gaslighting' and 'the law of attraction'. 🌈 . . <br /> <br /> Eventually, an aura of confidence, stronger opinions and new
                connections took over the room. The four walls which otherwise should have been confining, perhaps created the most liberated space✨
              </div>
            </div>
          </section>
        </main>
