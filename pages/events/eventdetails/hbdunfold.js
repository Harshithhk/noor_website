        ...
        <main>
          ...
          <section className={styles.description}>
            <div className={styles.desc_container}>
              <div className={styles.desc_date}>6 Dev 2020</div>
              <div className={styles.desc_heading}>HBD Unfold : 2020</div>
              <div className={styles.desc_description}>
                The one where Unfold turned one! <br /> <br /> We're so grateful to everyone who had been a part of this beautiful concept so far.
                We've learnt and grown so much from all the people that we have met, all the stories that we've heard and all the emotions that we
                have expressed. To everyone who's attended Unfold, we have always aimed to provide a non-judgemental platform where people can express
                themselves without any fears or insecurities. Achieving this milestone, with your support has motivated us to bring better experiences
                for you. We hope to see y'all soon at Unfold again!
              </div>
            </div>
          </section>
        </main>
