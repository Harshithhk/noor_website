export var upcomingEventsData = [
  {
    id: 1,
    color: "#FCD5E4",
    title: `Unfold - Relationships(Self)`,
    genre: "Upcoming",
    date: "29 aug 2021",
    short_description: "Your best investment? A good relationship with yourself!",
    description:
    ...
    cover_image_url: "/assets/images/Events/UnfoldRelationships.png",
    link: "/events/register/unfoldrelationships",
  },
  {
    id: 2,
    color: "#AAF1DB",
    title: "Valen’Times with Noor",
    date: "14 feb 2021",
    genre: "Past",
    short_description: "I find myself in various characters! Here’s what we discovered in this session... ",
    description:
  ...
  },
  {
    ...
    title: "Reflect: Now",
    date: "8 jan 2021",
    short_description: "It’s human to make mistakes but it is celestial to learn from it",
    description:
    ...
    genre: "Past",
    cover_image_url: "/assets/images/Events/Reflect.png",
    link: "/events/eventdetails/reflectnow",
  },
  {
    id: 4,
    color: "#C1E1FF",
    title: "HBD Unfold : 2020",
    date: "6 dec 2020",
    short_description: "The one where Unfold turned one! ",
    description: `We're so grateful to everyone who had been a part of this beautiful concept so far. We've learnt and grown so much from all the people that we have met, all the stories that we've heard and all the emotions that we have expressed. 
To everyone who's attended Unfold, 
...
`,
    genre: "Past",
    cover_image_url: "/assets/images/Events/HBDUnfold.png",
...

  {
    id: 5,
    color: "#E8C7FF",
    title: "Unfold : March 2020",
    date: "26 march 2020",
    short_description: `Closed eyes and open minds, could only make the talks deeper and more meaningful.`,
    description: `“Closed eyes and open minds, could only make the talks deeper and more meaningful.” That’s just how Unfold - February, 2020 was.❤️❤️
    Not only a session but a wholesome experience of being brave enough to pour your hearts out to strangers in exchange for support and encouragement. The participants unveiled answers to others’ deep questions and we were enlightened about lesser known and intriguing topics like 'gaslighting' and 'the law of attraction'. 🌈 .
.
...
`,
    genre: "Past",
    cover_image_url: "/assets/images/Events/Unfold.png",
